 ...
 * @author zawat
 */
public class b_issue extends javax.swing.JFrame {

    /**
     * Creates new form b_issue
     */
    public b_issue() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(540, 0, 283, 73);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 0, 1366, 58);
        ...
        jScrollPane1.setBounds(20, 10, 1324, 380);
        ...
        but_back.setBounds(21, 559, 136, 67);

        getContentPane().add(jDesktopPane1);
        jDesktopPane1.setBounds(0, 68, 1366, 700);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(b_issue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
